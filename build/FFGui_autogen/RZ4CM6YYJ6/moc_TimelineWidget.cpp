...
void TimelineWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->seekRequested((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        case 1: _t->clipSelected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->playheadChanged((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        case 3: _t->inPointChanged(); break;
        case 4: _t->outPointChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TimelineWidget::*)(double )>(_a, &TimelineWidget::seekRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TimelineWidget::*)(const QString & )>(_a, &TimelineWidget::clipSelected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TimelineWidget::*)(double )>(_a, &TimelineWidget::playheadChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TimelineWidget::*)()>(_a, &TimelineWidget::inPointChanged, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (TimelineWidget::*)()>(_a, &TimelineWidget::outPointChanged, 4))
            return;
    }
}
...
// SIGNAL 0
void TimelineWidget::seekRequested(double _t1)
{
...
// SIGNAL 3
void TimelineWidget::inPointChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void TimelineWidget::outPointChanged()
{
